GetMap1 = function ( xlocmin = 436000, xlocmax = 450000, ylocmin = 166000, ylocmax = 180000, gridnumber = "gl1", layer = "01", variable = "hydcond" )
	...
	assign (   paste ( "map", mapvariable, sep="" ),   cutnoise1   )
