...
ReadHydcondDat = function ( inputdir = dirdata, filename = "hydcond01.dat" )

	{

	filelist_part = list.files ( inputdir, pattern =  "hydcond[0-9]+.dat$" )
	filelist_full = list.files ( inputdir, pattern =  "hydcond[0-9]+.dat$", full.names = TRUE )
